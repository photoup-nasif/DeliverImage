...
|| public_key | (String) Required. Generated by the third party. |
|| otp | (String) Required. Generated by PhotoUp and was appended in the signup URL. Used by PhotoUp to determine which Client made the connection |
|-|-|-|
...
|| otp | (String) Required. Generated by PhotoUp and was appended in the signup URL. Used by PhotoUp to determine which Client made the connection |
|-|-|-|
| GET /home | | List out homes/properties. For response example See [Example Responses](#example-responses). Headers mentioned in [Authentication](#authentication) will be applied for this call. |
|| siteID | (String) Required. PhotoUp and the third Party will decide on the third party's siteID. |
